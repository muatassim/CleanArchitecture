...
namespace CleanArchitecture.ApiShared
{
    public static class DependencyInjectionExtensions
    {
        ...
        private static void RegisterApi(IServiceCollection services, ApiConfiguration model)
        {
            ...
            services.AddScoped<IEmployeesModelApi, EmployeesModelApi>();
            services.AddScoped<ICategoriesModelApi, CategoriesModelApi>();
            services.AddScoped<ICustomersModelApi, CustomersModelApi>();
            services.AddScoped<IShippersModelApi, ShippersModelApi>();
            services.AddScoped<ISuppliersModelApi, SuppliersModelApi>();
            services.AddScoped<IOrdersModelApi, OrdersModelApi>();
            services.AddScoped<IProductsModelApi, ProductsModelApi>();
            services.AddScoped<ICustomerDemographicsModelApi, CustomerDemographicsModelApi>();
            services.AddScoped<IRegionModelApi, RegionModelApi>();
            services.AddScoped<ITerritoriesModelApi, TerritoriesModelApi>();
        }
    }
}
