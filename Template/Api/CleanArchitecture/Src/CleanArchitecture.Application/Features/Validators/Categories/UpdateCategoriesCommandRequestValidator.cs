...
{
    public class UpdateCategoriesCommandRequestValidator(CategoriesMapper mapper) : IValidationHandler<UpdateCategoriesCommandRequest>
    {
        public async Task<ValidationResult> Validate(UpdateCategoriesCommandRequest request)
        {
